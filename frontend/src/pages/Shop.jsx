...
const Shop = () => {
  ...
  const handleCheck = (value, id) => {
    const updatedChecked = value ? [...checked, id]: checked.filter((check) => check !== id);
    ...
    <>
      <div className="container ml-[4rem]">
        <div className="flex md:flex-row">
          ...
          <div className="p-3">
            <h2 className="text-2xl font-bold mb-2">{products?.length} Products</h2>
